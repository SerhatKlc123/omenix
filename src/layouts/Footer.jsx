...
const sectors = ['Su/Kanalizasyon','Üretim'];
...
const Footer = () => {
    return(
        <div className="bg-gradient-to-b from-gray-800 to-black w-screen h-auto py-10 flex flex-col justify-center items-center text-white">
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-56 gap-10 md:px-36 px-10" style={{ justifyItems: 'start' }}>
                <FooterElement title="Ürünler" names={products}/>
                <FooterElement title="Sektörler" names={sectors}/>
